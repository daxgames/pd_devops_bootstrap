...
describe 'pd_devops_bootstrap::tmux' do
  context 'When all attributes are default, on mac_os_x' do
    ...
    it 'installs tmux' do
      expect(chef_run).to install_homebrew_package('tmux')
    end
  end
  ...
  context 'When all attributes are default, on ubuntu' do
    ...
    it 'installs tmux' do
      expect(chef_run).to install_apt_package('tmux')
    end
  end
  ...
  context 'When all attributes are default, on centos' do
    ...
    it 'installs tmux' do
      expect(chef_run).to install_yum_package('tmux')
    end
  end
end
